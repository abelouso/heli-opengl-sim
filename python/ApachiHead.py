...
class ApachiHead(BaseStateMachine):
    ...
    def dump(self, source):
        self.db(f"{source:10} ,T: {self.trg: 3.4f}, act: {self.act: 3.4f}, desRS: {self.desRotSpd: 3.4f}, " \
                f"actRotSpd: {self.actRotSpd: 3.4}, rotRate: {self.rotRate: 3.4f}, "\
                f"rotAccel: {self.rotAccel: 3.4f}, elapsed: {self.alt: 3.4f},")
